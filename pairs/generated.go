...
import "github.com/rgglez/go-storage/v5/types"
// WithCacheControl will apply cache_control value to Options.
// 
// CacheControl
func WithCacheControl(v string)(p types.Pair){
return types.Pair{Key:"cache_control",Value:v}}
...
// 
// ContentEncoding
func WithContentEncoding(v string)(p types.Pair){
return types.Pair{Key:"content_encoding",Value:v}}
// WithContentLanguage will apply content_language value to Options.
// 
// ContentLanguage
func WithContentLanguage(v string)(p types.Pair){
return types.Pair{Key:"content_language",Value:v}}
