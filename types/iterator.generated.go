...
type BlockPage struct{Status Continuable
Data []*Block
}
type BlockIterator struct{ctx context.Context
next NextBlockFunc
...
type ObjectPage struct{Status Continuable
Data []*Object
}
type ObjectIterator struct{ctx context.Context
next NextObjectFunc
...
type PartPage struct{Status Continuable
Data []*Part
}
type PartIterator struct{ctx context.Context
next NextPartFunc
...
type StoragerPage struct{Status Continuable
Data []Storager
}
type StoragerIterator struct{ctx context.Context
