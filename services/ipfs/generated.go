...
type ObjectSystemMetadata struct{Blocks int
...
func WithGateway(v string)( types.Pair){
return types.Pair{Key:"gateway",Value:v}}
type Factory struct{Endpoint string
Gateway string
WorkDir string
}
