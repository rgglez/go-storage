...
//
// Basic example for the obs (Huawei Cloud Object Storage) service.
//
// Run from this directory:
//
//	OBS_CREDENTIAL=hmac:ACCESS_KEY:SECRET_KEY \
...
//
//	OBS_CREDENTIAL  – HMAC credential: "hmac:ACCESS_KEY:SECRET_KEY"
//	OBS_ENDPOINT    – OBS endpoint (e.g. https://obs.cn-north-4.myhuaweicloud.com)
//	OBS_BUCKET      – bucket name
//
// Optional:
//
//	OBS_WORK_DIR    – key prefix (must start and end with "/")
package main
...
func main() {
	credential := requireEnv("OBS_CREDENTIAL")
	endpoint := requireEnv("OBS_ENDPOINT")
