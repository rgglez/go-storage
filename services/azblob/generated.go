...
type ObjectSystemMetadata struct{AccessTier string
...
// 
// See https://docs.microsoft.com/en-us/azure/storage/blobs/access-tiers-overview for
// details. Specifies the access tier.
func WithAccessTier(v string)( types.Pair){
return types.Pair{Key:"access_tier",Value:v}}
...
return types.Pair{Key:"encryption_key",Value:v}}
// WithEncryptionScope will apply encryption_scope value to Options.
// 
// See https://docs.microsoft.com/en-us/azure/storage/blobs/encryption-scope-overview
// for details. Specifies the name of the encryption scope.
func WithEncryptionScope(v string)( types.Pair){
return types.Pair{Key:"encryption_scope",Value:v}}
