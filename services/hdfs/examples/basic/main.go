...
//
// Basic example for the hdfs (Apache Hadoop Distributed File System) service.
//
// Run from this directory:
//
//	HDFS_ENDPOINT=tcp+addr://namenode.example.com:8020 \
//	go run main.go
//
// Required environment variables:
//
//	HDFS_ENDPOINT  – HDFS NameNode address: "tcp+addr://HOST:PORT"
//
// Optional:
//
//	HDFS_WORK_DIR  – HDFS path prefix (e.g. "/user/myapp/")
package main
...
func main() {
	endpoint := requireEnv("HDFS_ENDPOINT")
