...
//
// Basic example for the kodo (Qiniu Cloud Object Storage) service.
//
// Run from this directory:
//
//	KODO_CREDENTIAL=hmac:ACCESS_KEY:SECRET_KEY \
//	KODO_ENDPOINT=https://up.qiniup.com \
//	KODO_BUCKET=my-bucket \
//	go run main.go
//
// Required environment variables:
//
//	KODO_CREDENTIAL  – HMAC credential: "hmac:ACCESS_KEY:SECRET_KEY"
//	KODO_ENDPOINT    – Kodo upload endpoint (e.g. https://up.qiniup.com)
//	KODO_BUCKET      – bucket name
//
// Optional:
//
//	KODO_WORK_DIR    – key prefix (must start and end with "/")
package main
...
func main() {
	credential := requireEnv("KODO_CREDENTIAL")
	endpoint := requireEnv("KODO_ENDPOINT")
	bucket := requireEnv("KODO_BUCKET")
