...
//
// Basic example for the cos (Tencent Cloud Object Storage) service.
//
// Run from this directory:
//
//	COS_CREDENTIAL=hmac:SECRET_ID:SECRET_KEY \
//	COS_BUCKET=my-bucket \
//	COS_LOCATION=ap-beijing \
//	go run main.go
//
// Required environment variables:
//
//	COS_CREDENTIAL  – HMAC credential: "hmac:SECRET_ID:SECRET_KEY"
//	COS_BUCKET      – bucket name
//	COS_LOCATION    – COS region (e.g. ap-beijing, ap-guangzhou)
//
// Optional:
//
//	COS_WORK_DIR    – key prefix (must start and end with "/")
package main
...
func main() {
	credential := requireEnv("COS_CREDENTIAL")
	bucket := requireEnv("COS_BUCKET")
	location := requireEnv("COS_LOCATION")
