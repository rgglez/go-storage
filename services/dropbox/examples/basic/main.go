...
//
// Basic example for the dropbox (Dropbox cloud storage) service.
//
// Run from this directory:
//
//	DROPBOX_CREDENTIAL=apikey:ACCESS_TOKEN \
//	go run main.go
//
// Obtain an access token at https://www.dropbox.com/developers/apps.
//
// Required environment variables:
//
//	DROPBOX_CREDENTIAL  – Dropbox API token: "apikey:ACCESS_TOKEN"
//
// Optional:
//
//	DROPBOX_WORK_DIR    – path prefix (must start with "/")
package main
...
func main() {
	credential := requireEnv("DROPBOX_CREDENTIAL")
