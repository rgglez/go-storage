...
//
// Example code for the oss (Alibaba Cloud Object Storage) service.
//
...
// ExampleNewStorager demonstrates how to initialize an Alibaba Cloud OSS backend.
//
//	export OSS_CREDENTIAL=hmac:ACCESS_KEY_ID:ACCESS_KEY_SECRET
//	export OSS_ENDPOINT=https://oss-cn-hangzhou.aliyuncs.com
//	export OSS_BUCKET=my-bucket
func ExampleNewStorager() {
	ps := []types.Pair{
		pairs.WithCredential(os.Getenv("OSS_CREDENTIAL")),
		pairs.WithEndpoint(os.Getenv("OSS_ENDPOINT")),
		pairs.WithName(os.Getenv("OSS_BUCKET")),
	}
...
func ExampleStorage_Write() {
	_, store, err := oss.New(
		pairs.WithCredential("hmac:ACCESS_KEY_ID:ACCESS_KEY_SECRET"),
		pairs.WithEndpoint("https://oss-cn-hangzhou.aliyuncs.com"),
...
// ExampleServicer_Create demonstrates creating a new OSS bucket via the Servicer.
