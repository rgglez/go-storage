...
type ObjectSystemMetadata struct{ServerSideEncryption string
...
func WithServerSideDataEncryption(v string)( types.Pair){
return types.Pair{Key:"server_side_data_encryption",Value:v}}
...
func WithServerSideEncryptionKeyID(v string)( types.Pair){
return types.Pair{Key:"server_side_encryption_key_id",Value:v}}
...
if result.HasContentDisposition{
continue
}
result.HasContentDisposition = true
result.ContentDisposition = v.Value.(string)
...
if result.HasContentLanguage{
continue
}
result.HasContentLanguage = true
result.ContentLanguage = v.Value.(string)
case "content_md5":
