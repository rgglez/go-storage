...
//
// Basic example for the minio (MinIO / S3-compatible) service.
//
// Run from this directory:
//
//	MINIO_CREDENTIAL=hmac:ACCESS_KEY:SECRET_KEY \
...
//
//	MINIO_CREDENTIAL  – HMAC credential: "hmac:ACCESS_KEY:SECRET_KEY"
//	MINIO_ENDPOINT    – MinIO server endpoint (e.g. https://play.min.io)
//	MINIO_BUCKET      – bucket name
//
// Optional:
//
//	MINIO_WORK_DIR    – key prefix (must start and end with "/")
package main
...
func main() {
	credential := requireEnv("MINIO_CREDENTIAL")
