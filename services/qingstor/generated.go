...
type ObjectSystemMetadata struct{EncryptionCustomerAlgorithm string
StorageClass string
}
...
// WithCopySourceEncryptionCustomerAlgorithm will apply copy_source_encryption_customer_algorithm
// value to Options.
// 
// is the encryption algorithm for the source object. Only AES256 is supported now.
func WithCopySourceEncryptionCustomerAlgorithm(v string)( types.Pair){
return types.Pair{Key:"copy_source_encryption_customer_algorithm",Value:v}}
// WithCopySourceEncryptionCustomerKey will apply copy_source_encryption_customer_key value
// to Options.
// 
// is the customer-provided encryption key for the source object. For AES256 keys, the plaintext
// must be 32 bytes long.
func WithCopySourceEncryptionCustomerKey(v []byte)( types.Pair){
return types.Pair{Key:"copy_source_encryption_customer_key",Value:v}}
...
func WithEncryptionCustomerAlgorithm(v string)( types.Pair){
return types.Pair{Key:"encryption_customer_algorithm",Value:v}}
...
func WithEncryptionCustomerKey(v []byte)( types.Pair){
return types.Pair{Key:"encryption_customer_key",Value:v}}
...
type Factory struct{Credential string
...
case "http_client_options":
f.HTTPClientOptions = v.Value.(*httpclient.Options)
case "location":
...
return s.features}
type pairServiceCreate struct{pairs []types.Pair
HasLocation bool
Location string
}
...
type pairServiceDelete struct{pairs []types.Pair
HasLocation bool
Location string
}
...
type pairServiceGet struct{pairs []types.Pair
HasLocation bool
Location string
}
...
type pairServiceList struct{pairs []types.Pair
HasLocation bool
Location string
}
...
return s.features}
type pairStorageCombineBlock struct{pairs []types.Pair
}
...
err = types.NewOperationNotImplementedError("combine_block")
return }
type pairStorageCommitAppend struct{pairs []types.Pair
}
...
type pairStorageCompleteMultipart struct{pairs []types.Pair
}
...
type pairStorageCopy struct{pairs []types.Pair
...
for _, v := range opts{
switch v.Key{
case "copy_source_encryption_customer_algorithm":
if result.HasCopySourceEncryptionCustomerAlgorithm{
continue
}
result.HasCopySourceEncryptionCustomerAlgorithm = true
result.CopySourceEncryptionCustomerAlgorithm = v.Value.(string)
case "copy_source_encryption_customer_key":
if result.HasCopySourceEncryptionCustomerKey{
continue
}
result.HasCopySourceEncryptionCustomerKey = true
result.CopySourceEncryptionCustomerKey = v.Value.([]byte)
case "encryption_customer_algorithm":
if result.HasEncryptionCustomerAlgorithm{
continue
}
result.HasEncryptionCustomerAlgorithm = true
result.EncryptionCustomerAlgorithm = v.Value.(string)
case "encryption_customer_key":
if result.HasEncryptionCustomerKey{
continue
}
...
type pairStorageCreate struct{pairs []types.Pair
HasMultipartID bool
MultipartID string
HasObjectMode bool
...
type pairStorageCreateAppend struct{pairs []types.Pair
HasContentType bool
ContentType string
...
type pairStorageCreateBlock struct{pairs []types.Pair
}
...
err = types.NewOperationNotImplementedError("create_block")
return }
type pairStorageCreateDir struct{pairs []types.Pair
HasStorageClass bool
StorageClass string
}
...
type pairStorageCreateLink struct{pairs []types.Pair
}
...
type pairStorageCreateMultipart struct{pairs []types.Pair
HasEncryptionCustomerAlgorithm bool
EncryptionCustomerAlgorithm string
HasEncryptionCustomerKey bool
EncryptionCustomerKey []byte
...
type pairStorageCreatePage struct{pairs []types.Pair
}
...
err = types.NewOperationNotImplementedError("create_page")
return }
type pairStorageDelete struct{pairs []types.Pair
HasMultipartID bool
MultipartID string
HasObjectMode bool
ObjectMode types.ObjectMode
...
type pairStorageFetch struct{pairs []types.Pair
}
...
type pairStorageList struct{pairs []types.Pair
HasListMode bool
...
type pairStorageListBlock struct{pairs []types.Pair
}
...
err = types.NewOperationNotImplementedError("list_block")
return }
type pairStorageListMultipart struct{pairs []types.Pair
}
...
type pairStorageMetadata struct{pairs []types.Pair
}
...
type pairStorageMove struct{pairs []types.Pair
}
...
type pairStorageQuerySignHTTPCompleteMultipart struct{pairs []types.Pair
}
...
err = types.NewOperationNotImplementedError("query_sign_http_complete_multipart")
return }
type pairStorageQuerySignHTTPCreateMultipart struct{pairs []types.Pair
}
...
err = types.NewOperationNotImplementedError("query_sign_http_create_multipart")
return }
type pairStorageQuerySignHTTPDelete struct{pairs []types.Pair
}
...
err = types.NewOperationNotImplementedError("query_sign_http_delete")
return }
type pairStorageQuerySignHTTPListMultipart struct{pairs []types.Pair
}
...
err = types.NewOperationNotImplementedError("query_sign_http_list_multipart")
return }
type pairStorageQuerySignHTTPRead struct{pairs []types.Pair
HasEncryptionCustomerAlgorithm bool
EncryptionCustomerAlgorithm string
HasEncryptionCustomerKey bool
EncryptionCustomerKey []byte
...
type pairStorageQuerySignHTTPWrite struct{pairs []types.Pair
HasContentMd5 bool
ContentMd5 string
HasContentType bool
ContentType string
...
type pairStorageQuerySignHTTPWriteMultipart struct{pairs []types.Pair
}
...
err = types.NewOperationNotImplementedError("query_sign_http_write_multipart")
return }
type pairStorageRead struct{pairs []types.Pair
HasEncryptionCustomerAlgorithm bool
EncryptionCustomerAlgorithm string
HasEncryptionCustomerKey bool
EncryptionCustomerKey []byte
...
type pairStorageStat struct{pairs []types.Pair
HasMultipartID bool
MultipartID string
HasObjectMode bool
ObjectMode types.ObjectMode
...
type pairStorageWrite struct{pairs []types.Pair
HasContentMd5 bool
ContentMd5 string
HasContentType bool
ContentType string
...
type pairStorageWriteAppend struct{pairs []types.Pair
HasContentMd5 bool
ContentMd5 string
}
...
type pairStorageWriteBlock struct{pairs []types.Pair
}
...
err = types.NewOperationNotImplementedError("write_block")
return }
type pairStorageWriteMultipart struct{pairs []types.Pair
HasEncryptionCustomerAlgorithm bool
EncryptionCustomerAlgorithm string
HasEncryptionCustomerKey bool
EncryptionCustomerKey []byte
...
type pairStorageWritePage struct{pairs []types.Pair
}
