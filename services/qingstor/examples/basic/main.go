...
//
// Basic example for the qingstor (QingStor Object Storage) service.
//
// Run from this directory:
//
//	QINGSTOR_CREDENTIAL=hmac:ACCESS_KEY_ID:SECRET_ACCESS_KEY \
//	QINGSTOR_BUCKET=my-bucket \
//	QINGSTOR_LOCATION=pek3a \
//	go run main.go
//
// Required environment variables:
//
//	QINGSTOR_CREDENTIAL  – HMAC credential: "hmac:ACCESS_KEY_ID:SECRET_ACCESS_KEY"
//	QINGSTOR_BUCKET      – bucket name
//	QINGSTOR_LOCATION    – zone (e.g. pek3a, sh1a, gd2a)
//
// Optional:
//
//	QINGSTOR_ENDPOINT    – custom endpoint for private QingStor deployments
//	QINGSTOR_WORK_DIR    – key prefix (must start and end with "/")
package main
...
func main() {
	credential := requireEnv("QINGSTOR_CREDENTIAL")
	bucket := requireEnv("QINGSTOR_BUCKET")
	location := requireEnv("QINGSTOR_LOCATION")
