...
//
// Basic example for the storj (Storj decentralized cloud storage) service.
//
// Run from this directory:
//
//	STORJ_CREDENTIAL=apikey:ACCESS_GRANT \
//	STORJ_BUCKET=my-bucket \
//	go run main.go
//
// Generate an Access Grant at https://us1.storj.io/access-grants.
//
// Required environment variables:
//
//	STORJ_CREDENTIAL  – Storj access grant: "apikey:ACCESS_GRANT"
//	STORJ_BUCKET      – bucket name
//
// Optional:
//
//	STORJ_WORK_DIR    – key prefix (must start and end with "/")
package main
...
func main() {
	credential := requireEnv("STORJ_CREDENTIAL")
	bucket := requireEnv("STORJ_BUCKET")
