...
//
// Basic example for the us3 (UCloud Object Storage) service.
//
...
//
//	US3_CREDENTIAL=hmac:PUBLIC_KEY:PRIVATE_KEY \
//	US3_ENDPOINT=https://cn-bj.ufileos.com \
//	go run main.go
package main
...
func main() {
	fmt.Fprintln(os.Stderr, "ERROR: us3 service is not yet implemented.")
	fmt.Fprintln(os.Stderr, "The UCloud Object Storage backend has been defined but the implementation")
